...
This document explains how to use OpenSloth for DPO (Direct Preference Optimization) training, as well as future support for other RL training methods like KTO and ORPO.
...
- **KTO, ORPO** - Future RL methods (planned)
...
```python
from opensloth.scripts.opensloth_trainer import run_mp_training, train_on_single_gpu
